      ...
      >
        {shape.type === 'rect' ? (
          <Rect
            ...
            dash={isSelected || isArrowSource || shape.isAutoGenerated ? [] : [8, 6]}
            shadowColor="black"
      ...
      >
        <Layer>
          ...
          {arrows.map((arrow) => {
            ...
            if (from.x === to.x && from.y === to.y) return null; // Prevents 0-length arrow crash
            ...
            return (
              <Arrow
                ...
                dash={arrow.isAutoGenerated ? [] : [8, 8]}
